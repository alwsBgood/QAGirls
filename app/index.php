...
<head>
    ...
    <meta name="description" content=" Не знаешь, как заработать столько, чтобы больше не париться о деньгах? Устала быть “просто красоткой” и хочешь доказать, что у тебя тоже  есть мозги? Запишись на курс QA от GoIT — уже через 3 месяца ты станешь  востребованным IT-специалистом!">
    <meta name="keywords" content=" qa, goit, тестировщик, онлайн курс, онлайн курс по qa, как стать тестировщиком, карьера в it, работа в it для девушек, как начать работать в it ">
    ...
    <meta property="og:title" content="QA для девушек | Онлайн-курс по тестированию от GoIT" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                ...
                <img data-offset="10" src="img/sec_02-img-1.png" alt="Девушка в восторге">
            </div>
            <div  class="col-6 tr">
                <div class="wrap">
                    <img data-offset="-10" src="img/sec_02-img-2.png" alt="Идеальные туфли">
        ...
        <div class="row">
            ...
            <div class="col-5">
               <div class="img_wrapper">
                    <img data-offset="35" src="img/sec_02-img-3.png" alt="Грустная девушка без работы">
               </div>
            </div>
        </div>
        <div class="row">
...
<section id="sec_05">
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                <h2 class="p286">Почему QA <br /> — идеальная работа для девушки</h2>
        ...
        <div class="row">
           <div class="col-6">
               ...
               <div class="item">
                   ...
                   <p class="pink">GoIT вернет тебе деньги за весь курс.</p>
               </div>
           </div>
           <div class="col-6 tc">
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                ...
                <p class="text">...Стать востребованным IT-специалистом. <br /> Ни от кого не зависеть. </p>
            </div>
            <div class="col-6 ">
